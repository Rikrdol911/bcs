...
<input  type='hidden' pattern = '^^[a-zA-Z0-9]{1,}$'; name='codigo_pieza[]' value='".$codigo_pieza."'>
...
echo $campos;
$var="a".$rand;
$tabla="<tr class=".$var."><td><small>".$codigo."<small></td><td>".$nombre."</td><td>".$nombre_rango."</td><td>".$precio."</td><td>".$cantidad."</td><td>".$precio*$cantidad."</td><td><button type=".'button'." ps=".$rand." class=".'elim'." >x</button></td></tr>";
$vacio="";
?>
