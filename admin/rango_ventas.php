...
$total_monto=0;
$tmonto1=0;
$consulta=("SELECT * FROM factura WHERE habilitado=0 AND fecha BETWEEN date('$fecha1') AND date('$fecha2')");
      $s=cons($consulta);
...
Total IVA:&nbsp;'.number_format(($total_iva)/100000,2,",",".").'&nbsp;Bs.S.<br>Total:&nbsp;'.number_format((($total_iva+($total_monto)))/100000,2,",",".").'&nbsp;Bs.S.</h5>
</div>  
</h5>
</div>';   
        }else{
