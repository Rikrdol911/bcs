...
<h4>Total: '.number_format(((($subtotal*$iva)/100)+$subtotal),2,",",".").' Bs</h4>
        ...
        <hr>
Subtotal: '.number_format($subtotal,2,",",".").' Bs.S<br>
IVA '.$iva.'%: '.number_format(((($subtotal*$iva)/100)/1000),2,",",".").' Bs.S<br>
<h4>Total: '.number_format((((($subtotal*$iva)/100)+$subtotal)/1000),2,",",".").' Bs.S</h4>
              </div>';
     }else{
        echo '<div id="totales" class="callout callout-info">
Subtotal: '.number_format($subtotal,2,",",".").' Bs<br>
