...
$('.agregar').click(function(e) {
	  if($('#codigo_pieza').val().indexOf(" ") > 0){
    e.preventDefault();
    $('#error').show();
    $('#error').html("El campo no debe contener espacios.");
    $('#codigo_pieza').addClass('error');
    $('#codigo_pieza').fucus();
    
  }else{
    $('#codigo_pieza').removeClass('error');
    $('#error').hide();
  }
...
<div class="col-lg-4 col-md-4 col-xs-10">
          <div class="form-group">
                  <label for="Nombre">Codigo De Pieza</label>
                  <input type="text" class="form-control" placeholder="Codigo De Pieza" id="codigo_pieza" name="codigo_pieza"><span id="error"></span>
                </div>
                </div>
				<div class="col-lg-4 col-md-4 col-xs-10">
					<div class="form-group">
