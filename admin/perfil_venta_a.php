...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Volver</a></li>
...
$subtotal_fac=bcdiv($subtotal, '100000', 3);
$iva_fac=bcdiv(($subtotal*$iva)/100, '100000', 3);
$total_fac=bcdiv(((($subtotal*$iva)/100)+$subtotal), '100000', 3);
...
Subtotal: '.number_format($subtotal_fac,3,",",".").' Bs.S<br>
IVA '.$iva.'%: '.number_format($iva_fac,3,",",".").' Bs.S<br>
<h4>Total: '.number_format($total_fac,3,",",".").' Bs.S</h4>
              </div>';
     }else{
        echo 'Recoversi&oacute;n Monetaria 20-08-2018.<br>
        <div id="totales" class="callout callout-info">
Subtotal: '.number_format($subtotal,2,",",".").' Bs<br>
IVA '.$iva.'%: '.number_format((($subtotal*$iva)/100),2,",",".").' Bs<br>
<h4>Total: '.number_format(((($subtotal*$iva)/100)+$subtotal),2,",",".").' Bs</h4>
              </div>';
