...
if(isset($_POST['nombre'])){
	...
	if(($id_tipo=="") || ($dni=="") || ($telefono=="") || ($direccion=="") || ($nombre=="") || ($iva=="")){
...
if (!isset($_POST['id_pieza'])) {
	echo negativo ("Ha Ocurrido un Error en la Pieza");
	exit;
}
...
$fecha=date("Y-m-d");
$ins=("INSERT INTO factura (id_cliente,fecha,iva,habilitado,imp)
	VALUES ('$id_cliente','$fecha','$iva',0,0)");
cons($ins);
if(mysqli_affected_rows($_SESSION['conexion_database'])<=0){
