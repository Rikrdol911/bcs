...
$consulta2=("SELECT cantidad FROM detalle_factura WHERE id_pieza='$id_pieza' AND id_factura='$id_factura'");
  $r2=mysqli_query($_SESSION['conexion_database'],$consulta2) or die(mysqli_error($_SESSION['conexion_database']));
...
$f_or1=mysqli_query($_SESSION['conexion_database'],$consulta_or1) or die(mysqli_error($_SESSION['conexion_database']));
...
<style>
<!--
#tabla_inventario td{width:10%;padding:5px;}
...
echo alerta("No hay ningun inventario registrado");  
      ...
      $consulta3=("SELECT * FROM rango WHERE id_rango='$id_rango' AND habilitado=0 ORDER BY id_rango DESC;");
