...
//consulta de la OR
  $consultaor=("SELECT * FROM o_r WHERE id_or='$id_or' AND (habilitado=0 OR habilitado=3) LIMIT 1");
...
<?php
//TOTALES
$consulta=("SELECT * FROM o_r WHERE id_or='$id_or' AND (habilitado=0 OR habilitado=3) LIMIT 1");
...
$total_servicios=0;
$consulta=("SELECT * FROM servicios_or WHERE id_or='$id_or' AND habilitado=0  OR habilitado=3");
...
<tr>
<td style="width: 15.2%; vertical-align: middle;">
<img class="img1" src="generados/head_and_footer/logo_bosch.png">
</td>

<td style="width: 39.8%; text-align: left;">
<strong>
<span class="span2">BCS</span><br><span class="span2">AUTOMOTRIZ COROMOTO H, C.A</span></strong>
...
<span class="span3"><?php echo "<b>OR ".$numero_or."</b><br>Fecha:&nbsp;".$fecha_cierre."<br>&nbsp;<b>".$nombre_cliente."</b><br>".$nombre_tipo."&nbsp;-&nbsp;".$dni."<br>Tel&eacute;fono&nbsp;".$telefono_cliente."<br>&nbsp;".$correo; ?> </span>
</td>
</tr>
...
<td class="field"><?php echo ucwords(strtolower($nombre_marca));?>&nbsp;<?php echo $vin;?></td>
<td class="label">Modelo:</td>
<td class="field">
<?php echo ucwords(strtolower($modelo));?></td>
</tr>

<tr>
<td class="label">A&ntilde;o:</td>
<td class="field"><?php echo $ano;?></td>
<td class="label">Placa:</td>
<td class="field"><?php echo $placa;?></td>
</tr>

<tr>
<td class="label">Color:</td>
<td class="field"><?php echo ucwords(strtolower($color));?></td>
<td class="label">KM: </td>
<td class="field"><?php echo number_format($km,0,',','.')."&nbsp;KM";?></td>
</tr>
</table>

<table class="detail" style="border-top: none; margin: 0px 0px 1.5em 0px;">
<tr>
<td class="label" style="width: 100%; text-align: center;">Mano de Obra</td>
<td class="field" style="width: 4%;"></td>
</tr>
...
<tr class="head">
<td class="center" style="width: 10%">Codigo</td>
<td style="width: 20%">Descripci&oacute;n</td>
<td class="center" style="width: 8%">Horas</td>
<td class="center" colspan="2" style="width: 10%">Monto</td>
<td class="right" style="width: 10%;">Total</td>
</tr>



<?php
  $consultaor2=("SELECT * FROM o_r WHERE id_or='$id_or' AND (habilitado=0 OR habilitado=3) LIMIT 1");
...
<tr class="list_row">
<td class="center" style="padding:15px;"><?php echo $id_mano; ?></td>
<td>-&nbsp;<?php echo $nombre_mano; ?><br>
<?php
...
<td class="center"><?php echo $horas[$numero]; ?></td>
<td style="text-align: right;"><?php echo number_format($precios[$numero],2,",","."); ?></td>
<td>Bs.</td>
<?php 
$garant=$garantia[$numero];
if($garant==0){
...
<td></td>
<td></td>
<td style="text-align: right;"><hr><?php echo number_format($total_or,2,",","."); ?>&nbsp;Bs</td>
</tr>

<tr class="head">
<td class="center" style="text-align: center; width: 99%;border-top: none; margin: 0px 0px 1.5em 0px;" colspan="6">Repuestos</td>
  </tr>
<tr class="head">
<td class="center" style="width: 10%">Codigo</td>
<td style="width: 20%">Descripci&oacute;n</td>
<td class="center" style="width: 8%">Cantidad</td>
<td class="center" colspan="2" style="width: 10%">Precio Unit.</td>
<td class="right" style="width: 10%;">Total</td>
</tr>
...
?>
<tr class="list_row">
<td class="center" style="padding:5px;"><?php echo $f['codigo_pieza']; ?></td>

<td><?php echo $f['nombre']; ?></td>

<td class="center"><?php echo $cant; ?></td>

<td style="text-align: right"><?php echo $prec; ?></td>

<td>Bs.</td>
<?php 
if ($taller==0) {
?>
<td class="right"><?php echo number_format(($cant*$preciorepuesto),2,",",".").'&nbsp;Bs'; ?></td>
<?php 
}else{
?>
<td class="right">Traido Clien.
<?php
}
?>
</tr>
...
<td></td>
<td></td>
<td style="text-align: right;"><hr><?php echo number_format($total_repuestos,2,",","."); ?>&nbsp;Bs</td>
</tr>


<tr class="head">
<td class="center" style="text-align: center; width: 99%;border-top: none; margin: 0px 0px 1.5em 0px;" colspan="6">Servicios</td>
  </tr>
<tr class="head">
<td class="center" style="width: 10%">N° Control</td>
<td style="width: 20%">Descripci&oacute;n</td>
<td class="center" style="width: 8%">Precio Unit.</td>
<td class="center" colspan="2" style="width: 0%"></td>
<td class="right" style="width: 10%;">Total</td>
</tr>
<?php
...
?>
<tr class="list_row">
<td class="center" style="padding:5px;"><?php echo $ros['codigo']; ?></td>
<td><?php echo substr($ros['descripcion'], 0, 52); ?></td>
<td style="text-align: right;"><?php echo number_format($ros['monto'],2,",",".") ?></td>
<td class="left">Bs.</td>
</tr>
<?php
}//while
...
<hr>
<?php echo number_format($total_servicios,2,",","."); ?>&nbsp;Bs</td>
</tr>
...
<tr class="foot">
<td colspan="5" class="right" style="text-align: right; padding: 20px;" >Sub-Total:&nbsp;
<br>IVA(<?php echo $iva; ?>%):&nbsp;
<br><br><strong>Total:&nbsp;</strong><br><strong>Total Bs.S:&nbsp;</strong>
</td>
<td class="right">
<?php echo number_format($todo,2,",",".");?>&nbsp;Bs
<br><?php echo number_format((($todo*$iva)/100),2,",","."); ?>&nbsp;Bs
<br><hr><?php echo number_format(($todo+(($todo*$iva)/100)),2,",","."); ?>&nbsp;Bs
<?php
 $fecha_actual = strtotime(date("d-m-Y H:i:00",time()));
      $fecha_entrada = strtotime("01-07-2018 00:00:00");
  if($fecha_actual < $fecha_entrada){
?>
<br><?php echo number_format((($todo+(($todo*$iva)/100)))/1000,2,",","."); ?>&nbsp;Bs.S.
<?php
}else{}
...
if ($notas!="") {
?>
<p style="font-size: 0.65em">NOTAS:&nbsp;
<?php echo $notas; ?>
</p>
<?php
}
...
<table class="signature_table" style="text-align: center;">
  ...
  <tr>
    <td colspan="3" style="text-align: right; padding-top: 0em;"><?php echo $nombre_cliente; ?></td>
